...
lib.ssMetadata = [
		{name:"11_atlas_1", frames: [[0,0,1024,1024]]},
		{name:"11_atlas_2", frames: [[0,0,1024,1024],[0,1026,691,291],[1543,0,440,1067],[1026,0,515,1067]]}
];
...
(lib.Символ5 = function(mode,startPosition,loop) {
	...
	this.instance_1 = new lib.CachedBmp_2копия();
	this.instance_1.setTransform(114.5,-265.45,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_1},{t:this.instance}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Символ5, new cjs.Rectangle(-371.5,-267.3,743.5,535.4000000000001), null);
...
// stage content:
(lib.зад7текст = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/11_atlas_1.png", id:"11_atlas_1"},
		{src:"images/11_atlas_2.png", id:"11_atlas_2"}
	],
	preloads: []
};
