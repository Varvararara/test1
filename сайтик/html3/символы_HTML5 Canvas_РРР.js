...
lib.ssMetadata = [
		{name:"символы_HTML5 Canvas_РРР_atlas_1", frames: [[0,0,968,717]]}
];
...
(lib._20230302_003449 = function() {
	this.initialize(ss["символы_HTML5 Canvas_РРР_atlas_1"]);
	this.gotoAndStop(0);
...
lib.properties = {
	...
	manifest: [
		...
		{src:"images/Иллюстрация_без_названия15.png", id:"Иллюстрация_без_названия15"},
		{src:"images/крылоправо_.png", id:"крылоправо"},
		{src:"images/колесо_.png", id:"колесо"},
		{src:"images/Иллюстрация_без_названия14pngкопия.png", id:"Иллюстрация_без_названия14pngкопия"},
		{src:"images/символы_HTML5 Canvas_РРР_atlas_1.png", id:"символы_HTML5 Canvas_РРР_atlas_1"}
	],
	preloads: []
};
